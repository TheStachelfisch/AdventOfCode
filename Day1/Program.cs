...
namespace Day1
{
    ...
    {
        private static int[] _correctNumbers = new int[1];
        ...
        private static void Main(string[] args)
        {
            ...
            for (var j = 0; j < numbersArray.Length; j++)
                if (numbersArray[i] + numbersArray[j] == 2020)
                    _correctNumbers = new[] {numbersArray[i], numbersArray[j]};
            
            _correctNumber = _correctNumbers[0] * _correctNumbers[1];
            Console.WriteLine($"The Correct number is {_correctNumber}");
        }
    }
}